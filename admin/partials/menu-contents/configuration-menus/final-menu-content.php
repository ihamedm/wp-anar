...
در این مرحله محصولات از انار دریافت می شود.
    ...
    <div class="awca-save-products-wrapper" style="display:flex;align-items:center;justify-content:center;flex-direction: column;">
        ...
        <?php
        $creation_product_lock = get_transient('awca_product_creation_progress')
        ?>

        <button id="get-save-products-btn" class="awca_sync_btn" <?php echo $creation_product_lock ? 'disabled' : '';?> >
            ذخیره نهایی
