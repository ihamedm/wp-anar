...
class Payments{
    ...
    public function fetch_payments_ajax(){
        ...
        $response = ApiDataHandler::callAnarApi("https://api.anar360.com/api/360/orders/payment/pendings?page=$page&limit=$limit");
    ...
    public function count_unpaid_orders_count() {
        $response = ApiDataHandler::callAnarApi("https://api.anar360.com/api/360/orders/payment/pendings?page=1&limit=1");
