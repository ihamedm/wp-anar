...
/**
 * Abstract Anar_WP_Background_Process class.
 *
 * @abstract
 * @extends Anar_WP_Async_Request
 */
abstract class Anar_WP_Background_Process extends Anar_WP_Async_Request {
	 ...
	 *
	 * @param bool|array $allowed_batch_data_classes Optional. Array of class Anar_names that can be unserialized. Default true (any class).
	 */
	 ...
	 * Get batch.
	 *
	 * @return \Anar\stdClass Return the first batch of queued items.
	 */
	 ...
	 * @param bool|array $allowed_classes Array of class Anar_names that can be unserialized.
	 *
	 * @return mixed
	 */
